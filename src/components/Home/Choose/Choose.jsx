        ...
        <div className="max-w-[85%] mx-auto mb-20 mt-[300px] flex">
            <div className="relative flex-1">
                ...
                <div className="absolute top-7 left-[400px]">
                    ...
                    <img className="w-[290px] h-[250px]" src="https://s3-alpha-sig.figma.com/img/d045/72f5/d0025b831719a825d4a3bc18e6bc7cd6?Expires=1704672000&Signature=IcYd3HuYk0k4jddJe-dASNuy5uHdzOtI0XPbZYckaLWhepVdgQNGY6SLmwkQA~vU2TJLWkXdO6O99mY-asshr0VDEUGOFdTiMoruT3uTtdSomE315Rh3nCjNV5b0R243bWnifIRKyZIqofuNUBC~XY~-9symAyPdzxAJfj2PBd8B0Kha14KiQIc1fzd6wNR28G3RTC0IiMzIgx5-HCryF50iY83AKuvF6nnTuUdmIdJtZQQB-BRLzio8m0NKLaVMwyXMuDcdyVbbu5zAYE6Q9InTIL7Lp9yNoD6adzYrl6LYc~5hJi7XhqTV2pNu4Hv4EIxI3c8qoFuCuBC02KxWhw__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />
                </div>
                <div className="absolute top-[300px] left-[290px]">
            ...
            <div className="flex-1">
                <div>
                    ...
                    <div>
                        <div>
                            <h1 className="text-6xl font-bold text-[#010F58] mt-3">Why You Choose Our <br /> Kavinax Property</h1>
                            <p className='text-2xl mt-4 text-[#010F58]'>Excepteur sint occaecat cupidatat non proident,sunt inculpk qui officia <br /> deserunt mollit anim id est laborum.sed do eiusmod.</p>
                        </div>
                       <div className="grid grid-cols-2 gap-3">
                       <div className="mt-6">
                        <div className="flex gap-2 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
                                <circle cx="14.0913" cy="13.9124" r="12.7253" stroke="#FF5017" stroke-width="2" />
                                <circle cx="18.8844" cy="18.6434" r="13.7253" fill="#FF5017" />
                                <path d="M16.4623 21.1323C16.5966 20.9217 16.7186 20.7236 16.8446 20.5296C17.5816 19.3992 18.4212 18.3491 19.3397 17.3613C20.369 16.2544 21.4703 15.2265 22.6867 14.3246C23.1785 13.9602 23.6911 13.625 24.2203 13.3147C24.3062 13.2648 24.3533 13.2745 24.4032 13.3576C24.4516 13.4394 24.5084 13.5169 24.5694 13.5917C24.6234 13.6569 24.611 13.6943 24.5445 13.7441C23.7922 14.3094 23.1189 14.9619 22.4761 15.6462C21.7433 16.4248 21.0617 17.2477 20.4078 18.0928C19.5198 19.2426 18.6927 20.434 17.9792 21.7016C17.7853 22.0466 17.601 22.3957 17.4292 22.7518C17.4002 22.8113 17.3614 22.8557 17.3059 22.8931C16.8446 23.1965 16.3861 23.5026 15.9524 23.8448C15.8998 23.8864 15.8472 23.9279 15.7987 23.9736C15.746 24.0221 15.7225 24.0069 15.7017 23.9432C15.5895 23.5844 15.4509 23.2339 15.3041 22.8875C15.0243 22.2267 14.75 21.5631 14.3759 20.948C14.1418 20.5629 13.8702 20.2124 13.4754 19.9741C13.3909 19.9228 13.3023 19.8799 13.2094 19.8439C13.1693 19.8286 13.1471 19.8092 13.1859 19.7691C13.5475 19.4075 13.9298 19.0792 14.4313 18.9254C14.7832 18.8173 15.0797 18.8866 15.3373 19.1567C15.6047 19.438 15.7987 19.7649 15.9802 20.1029C16.1561 20.4313 16.2974 20.7762 16.4623 21.1323Z" fill="#F8FAFA" />
                            </svg>
                            <h1 className="text-2xl font-bold text-[#010F58] ">Trusted By Thousands</h1>
                        </div>
                        <p className="text-lg font-semibold ml-1">Donec sit amet urna libero Quisque <br /> efficitur nulla et odio hendrerit </p>
                        </div>
                       <div className="mt-6">
                        <div className="flex gap-2 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
